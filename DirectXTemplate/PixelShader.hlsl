...
float4 main(VertexToPixel input) : SV_TARGET
{
    ...
    float2 l1p1 = float2(50 * cos(time), 50 * sin(time));
    float2 l2p1 = float2(50 * cos(time + 1), 50 * sin(time + 1));
    float2 l3p1 = float2(50 * cos(time + 3.141), 50 * sin(time + 3.141));
