...
DirectX::XMFLOAT3 State::Camera::Position = DirectX::XMFLOAT3{ 0.0,0.0,-10.0f };
...
{
	float x = 10 * sinf(State::Time::Frame*0.01f);
	Position.x = x;
}

DirectX::XMFLOAT3 State::Light::Position = DirectX::XMFLOAT3{ 0,0,-1.0f };
